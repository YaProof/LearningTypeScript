...
const MergeSorting = require('./MergeSorting.js').default;
...
describe('Merging sort', () => {
  let sorting1 = new Sorting(sortingArray1(), new MergeSorting());
  let sorting2 = new Sorting(sortingArray2(), new MergeSorting());
